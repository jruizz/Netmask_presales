...
export const IconLibrary = (p) => (
  <svg {...base} {...p}><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V4H6.5A2.5 2.5 0 0 0 4 6.5v13Z" /><path d="M4 19.5A2.5 2.5 0 0 0 6.5 22H20" /><line x1="9" y1="8" x2="15" y2="8" /><line x1="9" y1="12" x2="15" y2="12" /></svg>
);
export const IconAudit = (p) => (
  <svg {...base} {...p}><circle cx="10.5" cy="10.5" r="6.5" /><line x1="15.5" y1="15.5" x2="21" y2="21" /><path d="M8 10.5l1.7 1.7L13.5 8.5" /></svg>
);
export const IconUsers = (p) => (
  <svg {...base} {...p}><circle cx="9" cy="8" r="3.2" /><path d="M3.5 20c0-3.3 2.9-5.5 5.5-5.5S14.5 16.7 14.5 20" /><circle cx="17.5" cy="8.5" r="2.4" /><path d="M15.5 14.3c2.6.3 4.5 2.2 4.5 5.7" /></svg>
);
export const IconLogout = (p) => (
  <svg {...base} {...p}><path d="M13 4h4a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-4" /><path d="M3 12h12" /><path d="M11 8l4 4-4 4" /></svg>
);
...
export const IconEye = (p) => (
  <svg {...base} {...p}><path d="M1 12s4.5-7 11-7 11 7 11 7-4.5 7-11 7-11-7-11-7Z" /><circle cx="12" cy="12" r="3" /></svg>
);
export const IconEyeOff = (p) => (
  <svg {...base} {...p}><path d="M1 12s4.5-7 11-7 11 7 11 7-4.5 7-11 7-11-7-11-7Z" /><line x1="4" y1="4" x2="20" y2="20" /><circle cx="12" cy="12" r="3" /></svg>
);
