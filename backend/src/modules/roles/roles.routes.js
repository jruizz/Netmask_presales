...
rolesRouter.get('/', requirePermiso('administrar_usuarios'), async (req, res, next) => {
  try {
...
rolesRouter.get('/permisos-disponibles', requirePermiso('administrar_usuarios'), async (req, res, next) => {
  try {
